...
class Aggregation(nn.Module):
    ...
    def forward(self, features_left, features_right, left_img, right_img):
        ...
        vol0 = self.conv0(vol0) + self.attdisp1(vol0) #N, attention_channels[0], H, W
        vol1 = self.conv1_init(corr1) #N, attention_channels[1], H, W
        vol1 = self.conv1(vol1) + self.attdisp2(vol1) #N, attention_channels[1], H, W
        vol2 = self.conv2_init(corr2) #N, attention_channels[2], H, W
        vol2 = self.conv2(vol2) + self.attdisp3(vol2) #N, attention_channels[2], H, W
