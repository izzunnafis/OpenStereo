...
class Aggregation(nn.Module):
    ...
    def process_corr(self, features_left, features_right, stage_idx):
        ...
        corr_res, disp_out = self.corr_as_att[stage_idx](features_left, features_right) #N, search_num*group_wise_split_num, H, W
        
        return corr_res, disp_out
    ...
    def forward(self, features_left, features_right):
        ...
        corr0, disp4 = self.process_corr(features_left_[0], features_right_[0], 0) #N, search_num*group_wise_split_num, H, W
        corr1, disp8 = self.process_corr(features_left_[1], features_right_[1], 1) #N, search_num*group_wise_split_num, H, W
        corr2, disp16 = self.process_corr(features_left_[2], features_right_[2], 2) #N, search_num*group_wise_split_num, H, W
        ...
        return vol_att012, disp4, disp8, disp16
