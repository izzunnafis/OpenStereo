...
from stereo.modeling.models.efficient_stereo16_better_disp.backbone import Backbone

# from .backbone import Backbone
from .aggregation import Aggregation, FPNLayer
from .transformer import DispAtt


class EfficientStereo16(nn.Module):
    def __init__(self, cfgs):
        ...
        self.disp_reg = DispAtt(self.cost_agg.attention_channels[0], nhead=4, attention="linear", max_disp=self.max_disp // 4)
    ...
    def forward(self, data):
        ...
        encoded_vol = self.cost_agg(features_left, features_right) # [bz, self.attention_channels[0], H/4, W/4]

        # init_disp = self.disp_reg(encoded_vol)  # [bz, 1, H/4, W/4]
