...
import time
from .aggregation import FPNLayer, BasicConv2d
...
class Backbone(nn.Module):
    def __init__(self, backbone=''):
        ...
        self.fpn_layer3 = FPNLayer(out_channel[2], out_channel[1])
        self.fpn_layer2 = FPNLayer(out_channel[1], out_channel[0])
    ...
    def forward(self, images):
        ...
        c1 = out_features[0] # [bz, C1, H/4, W/2]
        c2 = out_features[1] # [bz, C2, H/8, W/4]
        c3 = out_features[2] # [bz, C3, H/16, W/8]

        p2 = self.fpn_layer3(c3, c2)  # [bz, C2, H/8, W/4]
        p1 = self.fpn_layer2(p2, c1) # [bz, C1, H/4, W/2]
