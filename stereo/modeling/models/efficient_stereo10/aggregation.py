...
class Aggregation(nn.Module):
    def __init__(self, input_channel=[24, 32, 96], group_wise_split_num=[4,4,4], search_num=[9,25,25], corr_split_mode = [1,0,0], downsample_scale=[4, 8, 16], max_disp=192):
        ...
        self.enhance_conv0 = ASPP(self.attention_channels[0], self.attention_channels[0])
        ...
        self.enhance_conv1 = ASPP(self.attention_channels[1], self.attention_channels[1])
        ...
        self.enhance_conv2 = ASPP(self.attention_channels[2], self.attention_channels[2])
        ...
        self.enhance_conv1_0 = ASPP(self.attention_channels[0], self.attention_channels[0])
        ...
        self.enhance_conv1_1 = ASPP(self.attention_channels[1], self.attention_channels[1])
        ...
        self.enhance_conv2_0 = ASPP(self.attention_channels[0], self.attention_channels[0])
    ...
    def forward(self, features_left, features_right):
        ...
        vol_att12 = self.enhance_conv1_1(vol_att12) #N, attention_channels[1], H, W

        vol_att0 = self.conv1_0(vol_att0) #N, attention_channels[0], H, W
        vol_att0 = self.enhance_conv1_0(vol_att0) #N, attention_channels[0], H, W
        ...
        vol_att012 = self.enhance_conv2_0(vol_att012) #N, attention_channels[0], H, W
...
class ASPP(nn.Module):
    def __init__(self, in_channels, out_channels):
        ...
        self.atrous_block1 = nn.Conv2d(in_channels, out_channels, kernel_size=1, padding=0, dilation=1, groups=in_channels)
        self.atrous_block6 = nn.Conv2d(in_channels, out_channels, kernel_size=3, padding=6, dilation=6, groups=in_channels)
        self.atrous_block12 = nn.Conv2d(in_channels, out_channels, kernel_size=3, padding=12, dilation=12, groups=in_channels)
        self.atrous_block18 = nn.Conv2d(in_channels, out_channels, kernel_size=3, padding=18, dilation=18, groups=in_channels)
        ...
        self.conv1 = nn.Conv2d(out_channels * 5, out_channels, kernel_size=1, groups=out_channels)
        self.relu = nn.ReLU()
